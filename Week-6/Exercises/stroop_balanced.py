...
INSTR_START = """
In this task, you have to indicate the color of the word you see. Ignore the meaning of the word. 
Press J for blue and green, F for red and orange.
...
for block_id in range(1, N_BLOCKS + 1):
    trials=[]
    for _ in range( N_TRIALS_IN_BLOCK // 2):
    ...
    for trial_id, (trial_type, word, color) in enumerate(trials, start=1):
