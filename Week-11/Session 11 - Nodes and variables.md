...
Last time, we created a simple letter recognition task (file [here](./scripts/rich-timeline-tree.html)), with a fixation cross before each trial. You should also have added a blank after each trial.
